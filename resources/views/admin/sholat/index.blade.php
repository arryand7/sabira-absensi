...
<div class="mt-6 w-full sm:px-6 lg:px-8 space-y-6">
        <div class="bg-[var(--sabira-surface)] shadow-md rounded-2xl p-6">
            ...
            <h2 class="text-xl font-semibold text-[var(--sabira-ink)] mb-4">Master Data Sholat</h2>
            ...
            <form method="POST" action="{{ route('admin.sholat.store') }}" class="mb-4 flex gap-2">
                ...
                <button type="submit" class="bg-[var(--sabira-neutral-strong)] text-white px-4 py-2 rounded-md hover:bg-[var(--sabira-primary-active)] shadow">
